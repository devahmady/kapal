...
@section('content')
    <div class="panel">
        ...
        <div class="mb-5">
            <form class="space-y-5" method="POST" action="{{ route('bank.store') }}">
                @csrf
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-12">
                    <div>
                        <label for="name">Nama</label>
                        <input id="name" name="name" type="text" placeholder="nama bank" class="form-input" autocomplete="">
                    </div>
                    <div>
                        <label for="rekening">Rekening</label>
                        <input id="rekening" name="rekening" type="text" placeholder="000xxx" class="form-input" autocomplete="">
                    </div>
                </div>
